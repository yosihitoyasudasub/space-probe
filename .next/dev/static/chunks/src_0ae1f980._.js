...
;
;
const HUD = ({ status = 'Idle', velocity = 0, distance = 0, fuel = 100, slingshots = 0, velocityHistory = [], distanceHistory = [] })=>{
    _s();
...
_s(HUD, "+VkupDg6q/qiwQadCMbWziICfeE=");
_c = HUD;
...
//# sourceMappingURL=src_0ae1f980._.js.map